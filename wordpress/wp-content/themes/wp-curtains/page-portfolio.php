            ...
            <div class="container">
              <div class="row">
                <div class="page-tittle ">
                  <h1 class="upper phil-reg">Портфолио</h1>
                ...
                <div class="section-body">
                  <div class="portfolio-filter upper">
                    <div class="portfolio-filter__top">
                      ...
                      <a href="#" class="btn btn-filter all">все</a>
                      <a href="#" class="btn btn-filter">гОСТИНОЙ</a>
                      <a href="#" class="btn btn-filter">спальни</a>
                      <a href="#" class="btn btn-filter">детской</a>
                      <a href="#" class="btn btn-filter">кухни</a>
                      <a href="#" class="btn btn-filter">кабинета</a>
                      <a href="#" class="btn btn-filter">других помещений</a>
                      <a href="#" class="btn btn-filter">административных объектов </a>
                    </div>
                    <div class="portfolio-filter__bot">
                      <span class="gray-l">Примеры оформления:</span>
                      <a href="#" class="btn btn-filter all">все</a>
                      <a href="#" class="btn btn-filter btn-filter--img">
                        <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product1.png" alt="product">
                        <img class="pink" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product1-act.png" alt="product">
                      </a>
                      <a href="#" class="btn btn-filter btn-filter--img">
                        <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product2.png" alt="product">
                        <img class="pink" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product2-act.png" alt="product">
                      </a>
                      <a href="#" class="btn btn-filter btn-filter--img">
                        <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product3.png" alt="product">
                        <img class="pink" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product3-act.png" alt="product">
                      </a>
                      <a href="#" class="btn btn-filter btn-filter--img">
                        <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product4.png" alt="product">
                        <img class="pink" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product4-act.png" alt="product">
                      </a>
                      <a href="#" class="btn btn-filter btn-filter--img">
                        <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product5.png" alt="product">
                        <img class="pink" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product5-act.png" alt="product">
                      </a>
                      <a href="#" class="btn btn-filter btn-filter--img">
                        <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product6.png" alt="product">
                        <img class="pink" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product6-act.png" alt="product">
                      </a>
                      <a href="#" class="btn btn-filter btn-filter--img">
                        <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product7.png" alt="product">
                        <img class="pink" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product7-act.png" alt="product">
                      </a>
                      <a href="#" class="btn btn-filter btn-filter--img">
                        <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product8.png" alt="product">
                        <img class="pink" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product8-act.png" alt="product">
                      </a>
                      <a href="#" class="btn btn-filter btn-filter--img">
                        <img class="black" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product9.png" alt="product">
                        <img class="pink" src="<?php echo get_template_directory_uri(); ?>/img/product-type/product9-act.png" alt="product">
                      </a>
                      <a href="#" class="btn btn-reset fl-r">СБРОСИТЬ ФИЛЬТР</a>
                    </div>
                  </div>
                  <!-- end portfolio-filter -->
                  <div class="portfolio-rezalt">
                    <div class="block">
                      <a href="img/portfolio/1.jpg" data-toggle="lightbox" data-gallery="example-gallery">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/portfolio/1.jpg" alt="portfolio">
