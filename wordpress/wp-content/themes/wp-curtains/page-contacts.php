            ...
            <div class="container">
              <div class="row">
                <div class="page-tittle ">
                  <h1 class="upper phil-reg">Контакты</h1>
            ...
            <div class="container">
              ...
              <div class="col-xs-6 col-md-3 block nopadding xs-plr-15">
                  <div class="contacts-shop__top">
                    ...
                    <div class="tittle upper fira-bold orange">ТЦ «ТИТАН»</div>
                    <p>пр. Победителей 103</p>
                  </div>
                  <div class="contacts-shop__bot upper">
                    <i class="ic ic-clock"></i>
                    <p class="gray">ПН-ВТ: 8:00 - 20:00</p>
                ...
                <div class="col-xs-6 col-md-3 block nopadding xs-plr-15">
                  <div class="contacts-shop__top">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/marker.png">
                    <div class="tittle upper fira-bold orange">ТЦ «ПАРКТИНГ»</div>
                    <p>пр. Победителей 103</p>
                  </div>
                  <div class="contacts-shop__bot upper">
                    <i class="ic ic-clock"></i>
                ...
                <div class="col-xs-6 col-md-3 block nopadding xs-plr-15">
                  <div class="contacts-shop__top">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/marker.png">
                    <div class="tittle upper fira-bold orange">ТЦ «ГРАД»</div>
                    <p>пр. Победителей 103</p>
                  </div>
                  <div class="contacts-shop__bot upper">
                    <i class="ic ic-clock"></i>
                ...
                <div class="col-xs-6 col-md-3 block nopadding xs-plr-15">
                  <div class="contacts-shop__top">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/marker.png">
                    <div class="tittle upper fira-bold orange">ТЦ «ДОМАШНИЙ ОЧАГ»</div>
                    <p>пр. Победителей 103</p>
                  </div>
                  <div class="contacts-shop__bot upper">
                    <i class="ic ic-clock"></i>
